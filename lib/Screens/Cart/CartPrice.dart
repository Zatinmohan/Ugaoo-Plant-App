      ...
      child: Padding(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              PriceWidget(
                  title: "Cart Total", price: "Rs. 1000.0", isTotal: false),
              SizedBox(height: 10.0),
              PriceWidget(title: "GST", price: "Rs. 74.0", isTotal: false),
              SizedBox(height: 10.0),
              PriceWidget(title: "Delivery", price: "Rs. 50.0", isTotal: false),
              SizedBox(height: 12.0),
              Divider(height: 2.0, color: Colors.grey),
              SizedBox(height: 12.0),
              PriceWidget(title: "Total", price: "Rs. 1500", isTotal: true)
            ],
          ),
        ),
      ),
